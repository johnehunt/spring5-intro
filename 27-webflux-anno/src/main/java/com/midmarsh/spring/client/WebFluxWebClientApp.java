...
public class WebFluxWebClientApp {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// userMono.subscribe(WebFluxWebClientApp::handleResponse); // subcribe returns
		// immediately
		System.out.println("-----------------");
		...
		newUser.setTitle("Dr");
		Mono<User> responseUser = client.post().uri("/service").body(BodyInserters.fromObject(newUser)).retrieve()
				.bodyToMono(User.class);
		System.out.println(responseUser);
		responseUser.subscribe(WebFluxWebClientApp::handleResponse); // subscribe returns immediately
		...
		usersFlux.subscribe(WebFluxWebClientApp::handleResponse); // subscribe returns immediately
